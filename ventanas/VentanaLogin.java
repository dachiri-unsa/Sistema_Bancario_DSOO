    ...
    public VentanaLogin() {
        ...
        btnATM.addActionListener(e -> {
            try {
                ...
                Tarjeta tarjeta = SistemaBanco.getInstance().getBanco().getHashTarjetas().get(numeroTarjeta);
                if (tarjeta == null) {
                ...
                if (accion == 0) {
                    cajeroSeleccionado.depositarConTarjeta(tarjeta, monto, SistemaBanco.getInstance().getBanco().getGestorMovimientos());
                } else if (accion == 1) {
                    cajeroSeleccionado.retirarConTarjeta(tarjeta, monto, SistemaBanco.getInstance().getBanco().getGestorMovimientos());
                }
